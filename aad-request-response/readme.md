...
- Resource ID: `https://graph.micosoft.com/`
- Endpoint: `https://graph.micosoft.com/beta/`
  - `https://graph.micosoft.com/beta/me`
  - `https://graph.micosoft.com/beta/myOrganization`
